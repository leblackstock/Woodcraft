...
- current_asset: `40_listings/list_marketplace_raised_bed_001.md`
- asset_id: `list_marketplace_raised_bed_001`
...
- shipping: No shipping in this draft
- assembled_vs_kit_recommendation: Use the approved wording `pickup or local delivery by arrangement`. Do not promise kit delivery.
- lead_time: Built to order; lead time confirmed when order is placed

## Internal Copy Prep Notes
