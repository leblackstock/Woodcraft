...
For a non-bundle variant-scope listing, use ten images by default. The active generator owns the detailed override: Images 1 and 2 show the full selected scope, Images 3 through 5 are individual use-case-and-size-context combo photos, Image 6 remains Detail / Trust, and Images 7 through 10 are the scope options/prices, dimensions, selection details, and ordering cards. Do not treat this as a bundle sequence or use Image 6 as support/variation.
...
| Pre-2 | USA1-L-NAT — Wavy Flag Large; USA1-SML-NAT — Wavy Flag Small, Medium & Large Natural; USA1-SML-RUS prep scope — Wavy Flag Small, Medium & Large Rustic | USA1-L-NAT was posted 2026-06-23; monitor its metrics. USA1-SML-NAT/RUS prep-and-audit finished 2026-06-26, so this no longer blocks Wave 2 prompt-pack creation. USA1-SML-NAT is the renamed Natural scope and now uses the DEC-113 ten-image variant-scope prompt pack. DEC-110 authorizes `USA1-L-NAT_wavy_wooden_american_flag_ref_clean-01.png` plus `USA1-SML-NAT_wavy_wooden_american_flag_ref_clean-01.png` as the paired fallback visual-reference set for Medium, Small, and USA1-SML-NAT Marketplace-image preparation only. USA1-SML-RUS remains prep-only: no RUS Marketplace listing has been created. USA1-L-RUS clean reference is approved and active, and USA1-SML-RUS scope reference is approved. USA1-SML-RUS still needs Medium and Small individual RUS references before the full scoped listing-image pack, Claude submission, or publication work. First-build, factual, and publication gates remain. |
| 2 | B; C; G; H | Ready after the completed USA1-SML-NAT/RUS prep-and-audit: create the Wave 2 image prompt pack, then run B first before moving one SKU at a time through C, G, and H. |
...
| USA1-SML-NAT | Wavy Wooden American Flag — Small, Medium & Large — Natural Wood with Red & Blue Stain | `40_listings/list_marketplace_usa1_sml_nat_001.md` | n/a | $50 entry | `C:\Users\outdo\Documents\Woodcraft Catalog Setup\Facebook Marketing\Marketplace\USA1\USA1-SML-NAT` | Pre-2 | Draft; NAT rename/audit complete 2026-06-26; DEC-113 ten-image prompt pack prepared; final copy/media/publication gates pending | Run and approve the new NAT ten-image pack before publication. |
| USA1-SML-RUS prep scope | Wavy Wooden American Flag — Small, Medium & Large — Rustic Torched Wood | Prep placeholder: `40_listings/list_marketplace_usa1_sml_rus_001.md` | n/a | Future $50 entry | No RUS Marketplace listing folder or finished media exists; Large RUS and S/M/L scope refs approved; Medium/Small individual refs pending | Pre-2 | No listing created; prompt-only boundary verified 2026-06-26; Large RUS and S/M/L scope references approved 2026-06-24; Medium, Small, final copy, and publication gates pending | Do not create or publish a RUS listing until Medium and Small individual RUS clean references, full scoped image pack, Claude submission, and operator review are complete. |
