...
Use this only after the individual clean references for every scoped variant exist and are approved. This creates listing-level reference media; it does not create a new product, bundle, SKU, or customer-facing listing image.
...
- required_attachments: [[EVERY_INCLUDED_VARIANT_CLEAN_REFERENCE_FILENAME]]
...
```text
Please see attached "[[plain-language description of every approved individual clean reference being attached]]".
