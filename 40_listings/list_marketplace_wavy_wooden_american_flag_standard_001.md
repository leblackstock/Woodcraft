# Facebook Marketplace Listing — Wavy Wooden American Flag Standard Sizes

## Listing Identity

- listing_id: list_marketplace_wavy_wooden_american_flag_standard_001
- listing_ref: Wavy Flag Small + Medium
- listing_handle: usa1-sm
- product_id: prod_usa_wavy_wooden_american_flag_usa1
- product_family_id: prod_usa_wavy_wooden_american_flag_usa1
- variant_scope: USA1-S-NAT, USA1-M-NAT
- channel: Marketplace
...
- material_details: Planned pine variants in Natural Wood with Red & Blue Stain colorway.

## Fulfillment And Media

- location_scope: Locally in Georgia
- pickup_delivery_options: Pickup or local delivery by arrangement after approval
...
- clean_reference_generation_prompt_refs: 40_listings/prompts/prompt_usa1_s_nat_clean_reference_generator_2026-06-21.md | 40_listings/prompts/prompt_usa1_m_nat_clean_reference_generator_2026-06-21.md
- image_prompt_pack_refs: 40_listings/prompts/fbm_image_prompt_pack_usa1_s_nat_wavy_flag_2026-06-21.md | 40_listings/prompts/fbm_image_prompt_pack_usa1_m_nat_wavy_flag_2026-06-21.md
- claude_copy_prep_refs: 40_listings/prompts/claude_fbm_listing_copy_prompt_usa1_s_nat_wavy_flag_2026-06-21.md | 40_listings/prompts/claude_fbm_listing_copy_prompt_usa1_m_nat_wavy_flag_2026-06-21.md

## Performance Log

- publish_date:
- published_variant_scope:
- live_listing_url:
- views:
- saves:
- messages:
...
- notes: Scope is Small + Medium only. If Large is added, create a new variant-scope listing record and handle rather than changing this live offer.
