...
- customer_copy_prep_notes: Non-Claude prep only. Working post-copy idea highlights a new cedar planter box for flowers, herbs, or porch/patio use, mentions approximate 24x24x18 size, and points buyers to Marketplace for current availability and lead time after facts are confirmed.
- hashtag_notes: Keep light. Use 3 to 5 tags max such as #cedarplanter #handmade #outdoorplanter.
- local_context_tags: Assumption — add base city/county tags before publishing.
