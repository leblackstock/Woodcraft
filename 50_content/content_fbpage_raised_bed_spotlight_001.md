...
- historical_gate_exception_reason: The post was already published and the operator screenshot captured its visible copy, but no Claude handoff or pasted-back Claude output was recorded. This record is archival only; any revision must restart the Claude gate.
...
- recent_post_history_ref: Historical planter rotation evidence was reviewed with this record on 2026-06-04; one prior Facebook Page record with completed selected creative fields was available. The retired historical record is not an active content source.
