...
- plans_available: Yes
- plans_source_ref: 20_research/whosthevoss_planter_summary.md — 3 Picket Planter → `3 Pickets, FREE Plans | Make Money Woodworking | How To` | 20_research/whosthevoss_2026_pricing_guide_reference.md — Planter Box A
...
- target_buyer: Local homeowners wanting a small cedar porch or patio planter.
- primary_use_case: Compact flower or herb planter for entryways and small outdoor spaces.
- seasonal_notes: Assumption — strongest in spring and gift-friendly seasonal windows, but still useful year-round as a simple porch accent.
...
- comparable_examples: Assumption — simple cedar entry-level planters are easy for Marketplace buyers to understand and compare quickly.
- local_price_range: Assumption — about $35 to $65 locally for small cedar planters; formal comp capture still needed.
- demand_signals: Assumption — strong low-friction use case, gift/add-on potential, and high repeatability for batch-style production.
